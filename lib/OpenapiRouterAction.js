...
function OpenapiRouterAction(openapiRouter) {
    return async (ctx, next) => {
        ...
        if ((actionInfo === null || actionInfo === void 0 ? void 0 : actionInfo.action) === undefined) {
            ctx.status = 501;
            return;
        }
            ...
            do {
                ...
                if (reponseSchema) {
                    try {
                        ...
                        const resContentSchema = doc_ver === 2 ? (_j = reponseSchema) === null || _j === void 0 ? void 0 : _j.schema : (_k = reponseSchema === null || reponseSchema === void 0 ? void 0 : reponseSchema.content[contentType]) === null || _k === void 0 ? void 0 : _k.schema;
